...
class Config:
    ...
    def __init__(
        ...
        # [NEW] Construction Mode: single, aggregated, or both
        self.seidr_construction_mode = seidr_cfg.get("mode", seidr_cfg.get("construction_mode", "single"))
    ...
    def get_tool_opts(self, tool: str) -> Dict[str, Any]:
        ...
        if tool == "seidr":
            return {
                ...
                "mode": self.seidr_construction_mode,
